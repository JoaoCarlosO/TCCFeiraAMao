...
const produtos = [
  ...
  { id: "5", nome: "Palmito", preco: "R$25,00", imagem: require("../../../assets/img/palmito.png") },
...
export default function HomeVend({ navigation }) {
  return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.containerPerfil}>
          <View style={{ flexDirection: "row" }}>
            <Image source={require("../../../assets/img/Ftperfil.jpg")} style={styles.imgPerfil} />
