      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.areaForm}>
            ...
            <Text style={styles.textForm}>Digite o endereço</Text>
            <TextInput
              style={styles.input}
            ...
            <Text style={styles.textForm}>Digite os integrantes</Text>
            <TextInput
              style={styles.input}
              value={formData.cpf}
            ...
            <Text style={styles.textForm}>Adicione suas redes socias</Text>
            <TextInput
              style={styles.input}
            ...
            <Text style={styles.textForm}>Adicione uma biografia</Text>
            <TextInput
              style={styles.input}
            ...
            <Text style={styles.textForm}>Adicione a categoria da sua barraca</Text>
            <TextInput
              style={styles.input}
