      ...
      >
        ...
        >
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.subtitulo}>Feirante</Text>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => navigation.navigate("AlterarVend", { nome: user.name })}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("BarracaVend")}
          >
...
const styles = StyleSheet.create({
  ...
  buttonText: {
    marginLeft: 8,
    color: "#BCAF77",
    // Se quiser usar fonte Urbanist, faça isso:
    // fontFamily: "Urbanist",
    fontWeight: "bold",
  },
  logoutText: {
